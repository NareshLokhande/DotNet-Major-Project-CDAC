            ...
            variants: [
              ...
              },
              {
                ...
                style: {
                  ...
                  borderWidth: "2px",
                  "&:hover": {
                    backgroundColor: alpha(brand[500], 0.05),
              ...
              },
              {
                ...
                style: {
                  ...
                  boxShadow: `inset 0 2px 0 ${alpha(
                    red[200],
                    0.2
                  )}, inset 0 -2px 0 ${alpha(red[700], 0.4)}`,
              ...
              },
              {
                ...
                style: {
                  ...
                  boxShadow: `inset 0 2px 0 ${alpha(
                    orange[200],
                    0.2
                  )}, inset 0 -2px 0 ${alpha(orange[700], 0.4)}`,
                  ...
                  "&:active": {
                    backgroundColor: orange[700],
                    boxShadow: `inset 0 2.5px 0 ${alpha(orange[700], 0.4)}`,
                  },
                },
              },
              {
      ...
      MuiCard: {
        styleOverrides: {
          root: {
            ...
            boxShadow: `0 2px 4px ${alpha(gray[600], 0.2)}`,
            "&:hover": {
              boxShadow: `0 4px 8px ${alpha(gray[600], 0.3)}`,
            },
          },
        },
      },
